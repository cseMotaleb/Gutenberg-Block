 ...
 * Text Domain: sm-block
 * Domain Path: /languages
 *
 * @package Simple Gutenberg Block
 */

define( 'SB_PLUGIN_URL', plugins_url( 'sm-block' ) );
...
function gutenberg_custom_blocks() {
   ...
   register_block_type(
      'sm-block/simple-block',
      array(
         'style'         => 'sm-block-front-end-styles',
         'editor_style'  => 'sm-block-editor-styles',
         'editor_script' => 'sm-block-editor-js',
      )
   );
